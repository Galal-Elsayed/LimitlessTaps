      ...
      <form className="space-y-6 flex-1 flex flex-col" onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              <span className="text-[10px] bg-white/5 text-gray-500 px-3 py-1 rounded-full font-medium border border-white/5">
                {t("form.name.hint")}
              </span>
            </div>
            <input
              ...
              className="w-full bg-white/5 border border-white/10 rounded-2xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-white/20 transition-all disabled:opacity-50 h-14 text-start"
              placeholder=""
            />
          </div>
        ...
        <div className="space-y-2">
          ...
          <Select onValueChange={setSubject} required disabled={isSubmitting}>
            <SelectTrigger className="w-full h-14 rounded-2xl border-white/10 bg-white/5 text-white focus:ring-white/20 uppercase font-bold tracking-tight text-start">
            ...
            <SelectContent className="bg-[#101217] border-white/10 text-white rounded-2xl">
              <SelectItem value="general">
                {t("form.subject.options.general")}
              </SelectItem>
              <SelectItem value="project">
                {t("form.subject.options.project")}
              </SelectItem>
              <SelectItem value="support">
                {t("form.subject.options.support")}
              </SelectItem>
              <SelectItem value="feedback">
                {t("form.subject.options.feedback")}
              </SelectItem>
            </SelectContent>
          </Select>
        </div>
        ...
        <div className="space-y-2 flex-1 flex flex-col">
          ...
          <div className="relative flex-1 flex flex-col">
            <textarea
              ...
              className="w-full h-full min-h-[150px] bg-white/5 border border-white/10 rounded-3xl px-4 py-4 text-white focus:outline-none focus:ring-2 focus:ring-white/20 transition-all resize-none disabled:opacity-50 text-start"
              placeholder=""
            ></textarea>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <a
              ...
              className={`
                ...
                text-white font-extrabold text-sm tracking-wider uppercase
                shadow-[0_5px_0_0_#128c7e]
                hover:translate-y-0.5 hover:shadow-[0_2px_0_0_#128c7e]
                active:translate-y-1 active:shadow-none
                transition-all duration-100 ease-out
                flex items-center justify-center
                group
              `}
            >
              <span className="text-sm relative font-bold uppercase tracking-widest flex items-center justify-center gap-3">
                {t("grid.whatsApp.button")}
                <Image
