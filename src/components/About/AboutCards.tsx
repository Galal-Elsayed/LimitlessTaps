                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-3 lg:gap-8">
                    {services.map((service, index) => (
                        <motion.div
                            ...
                            className="group relative flex h-[450px] md:h-[500px] w-[90%] sm:w-[80%] md:w-full mx-auto flex-col overflow-hidden border border-white/[0.08] bg-gradient-to-b from-[#121212] via-black/30 to-black hover:border-white/20 hover:shadow-2xl hover:shadow-neutral-500/10 rounded-[2rem] cursor-pointer"
                        >
