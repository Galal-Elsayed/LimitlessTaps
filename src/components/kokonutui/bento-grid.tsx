...
const CounterAnimation = ({
  ...
  return (
    <div className="flex items-baseline gap-1">
      ...
      <span className="font-medium text-neutral-100 text-xl">
        {suffix}
      </span>
    </div>
  );
...
const IconsFeature = () => (
  <div className="mt-4 grid grid-cols-3 gap-4">
    <motion.div className="group flex flex-col items-center gap-2 rounded-xl border border-neutral-700/50 bg-gradient-to-b from-neutral-800/80 to-neutral-800 p-3 transition-all duration-300 hover:border-neutral-600">
      ...
      <span className="text-center font-medium text-neutral-400 text-xs group-hover:text-neutral-200">
        OpenAI
      </span>
    </motion.div>
...
const TimelineFeature = ({
  ...
  <div className="relative mt-3">
    ...
    {timeline.map((item) => (
      ...
      >
        <div className="z-10 mt-0.5 h-5 w-5 flex-shrink-0 rounded-full border-2 border-neutral-600 bg-neutral-800" />
        <div>
...
const TypingCodeFeature = ({ text }: { text: string }) => {
  ...
  return (
    <div className="relative mt-3">
      ...
      <div
        className="h-[150px] overflow-y-auto rounded-md bg-neutral-900 p-3 font-mono text-neutral-100 text-xs dark:bg-black dark-scrollbar"
        ref={terminalRef}
      >
  ...
  return (
    <div className="w-full py-4">
      <div className="relative mx-auto flex w-full max-w-xl flex-col items-center gap-2">
        ...
        <p className="h-4 text-white/70 text-xs">
        ...
        >
          <div className="flex flex-1 flex-col space-y-2">
            <div className="flex items-center justify-between">
              <h3 className="font-semibold text-neutral-100 text-xl tracking-tight transition-colors duration-300 group-hover:text-neutral-300">
                {item.title}
              </h3>
...
export default function BentoGrid({ className = "" }: { className?: string }) {
  return (
    <motion.div
      className={cn("grid gap-6 max-w-7xl mx-auto", className)}
      initial="hidden"
    ...
    >
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <motion.div
          className="overflow-hidden rounded-xl border border-neutral-800/50 bg-gradient-to-b from-neutral-900/80 to-neutral-900 transition-all duration-300 hover:border-neutral-600/30 hover:shadow-neutral-900/20 md:col-span-1"
          variants={fadeInUp}
        >
          <div className="p-5">
            <div className="mb-4 flex items-center justify-between">
              <h3 className="font-semibold text-neutral-100 text-xl tracking-tight">
                Voice Assistant
              </h3>
            </div>
            <p className="mb-4 text-neutral-400 text-sm tracking-tight">
