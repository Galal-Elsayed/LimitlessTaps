...
void main() {
  ...
  gl_FragColor  = color;
    ...
    return <div ref={containerRef} className={cn("absolute inset-0 z-0", className)} />;
};


// --- REUSABLE SERVICE HERO BASE ---

interface ServiceHeroBaseProps {
...
export default function ServiceHeroBase({ title, className, raysColor = "#ffffff", minHeight = "h-[30vh] md:h-[50vh]" }: ServiceHeroBaseProps) {
    ...
    return (
        <section className={cn("relative w-full flex flex-col items-center justify-center overflow-hidden bg-[#0a0a0a]", minHeight, className)}>
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-[#0a0a0a]/50 via-transparent to-[#0a0a0a]/50 pointer-events-none z-0" />
        </section>
    );
}
