...
export default function ContentCarousel({ items, textVariant = "default" }: ContentCarouselProps) {
  ...
  return (
    <div className="w-full relative">
      <div
        ref={containerRef}
        className="flex gap-6 overflow-x-auto snap-x snap-mandatory scrollbar-hide pb-8 px-6 md:px-12"
        ...
        {items.map((item, index) => (
          ...
          {/* Play/Pause Button - Hide if autoPlay is true */}
            ...
            <div className="mt-6 text-center md:text-left">
              <div className={`text-sm md:text-base font-medium leading-relaxed font-[family-name:var(--font-sf-text)] ${
                  textVariant === 'linear' 
